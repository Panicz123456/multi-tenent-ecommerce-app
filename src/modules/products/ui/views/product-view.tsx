...
// TODO: Real ratings need to be implemented
            ...
            <div className="border-t lg:border-t-0 lg:border-l h-full">
              <div className="flex flex-col gap-4 p-6 border-b">
                <div className="flex flex-row items-center gap-2">
                  {/*  if you purchase this product as login user you have button to redirect to product you buy                     */}
                  <CartButton
                ...
                <p className="text-center font-medium">
                  {data.refoundPolicy === "no-refunds"
                    ? "No refunds"
                    : `${data.refoundPolicy} money back guarantee`}
                </p>
              </div>
